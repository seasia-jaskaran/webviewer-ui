 ...
 */
const disableClearMoveOnPanelCloseClosure = (store) => () => {
  store.dispatch(actions.setClearMoveOnPanelClose(false));
};

export default disableClearMoveOnPanelCloseClosure;
